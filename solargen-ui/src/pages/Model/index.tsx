    ...
    return (
        <main className={`page ${styles.model}`}>
            <header className={styles.modelHeader}>
                <h1 className="page-title">Modèle Machine Learning</h1>
                <a
                    href="https://nbviewer.org/github/wajrock/solargen/blob/develop/solargen-model/model/model_development.ipynb"
                    target="_blank"
                >
                    <Button className={styles.modelReportLink}>
                ...
                {statusError ? (
                    ...
                    <div className={styles.predictionsStatus}>
                        ...
                        <span className={styles.predictionsStatusFetchDate}>
                            Calculées le {formatDate(new Date(predictionsStatusData!.fetched_at), 'dd/MM/yy à HH:mm')}
                        </span>
                    </div>
                )}
            </section>
